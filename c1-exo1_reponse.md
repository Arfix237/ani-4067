...
int main (void){
    float periodMs(int frequence)
    int f1 = 72, f2 = 90, f3 = 120;

    periodMs(int frequence){
    ...
    std::cout<<"Pour 90 hertz on a: "periodMs(f1)<<std::endl;
    std::cout<<"Pour 120 hertz on a: "periodMs(f1)<<std::endl;
    return 0;
}
```
## Compilation
